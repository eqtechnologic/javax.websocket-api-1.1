 ...
 * the {@link Endpoint#onOpen(jakarta.websocket.Session, jakarta.websocket.EndpointConfig) onOpen} method, the programmatic endpoint gains access to the {@link Session} object, 
 ...
 * {@link jakarta.websocket.server.ServerEndpointConfig.Configurator#getEndpointInstance} 
 * method to obtain the 
 * endpoint instance it will use for each new client connection.  If the developer uses 
 * the default {@link jakarta.websocket.server.ServerEndpointConfig.Configurator}, 
 ...
 * at a time.
 * 
 * <p>If the developer provides a custom {@link jakarta.websocket.server.ServerEndpointConfig.Configurator}
